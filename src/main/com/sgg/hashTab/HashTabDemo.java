...
class EmpLinkedList{
    //头指针，指向第一个Emp   head 有效直接指向Emp
    private Emp head ;
    //添加雇员到链表
    //说明
    //1.假定，当添加雇员时，id是自增长，id的分配是从小到大
